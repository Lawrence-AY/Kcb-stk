...
export const createTransaction = async (req: Request, res: Response) => {
  try {
    ...
    await getRegistrationsCollection().doc(merchantRequestId).set({
      ...
      internal_reference: internalReference || internal_reference || null,
      payment_category: paymentCategory || payment_category || category,
      kcb_endpoint: kcbEndpoint || kcb_endpoint || req.path,
